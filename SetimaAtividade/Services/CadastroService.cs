...
using SetimaAtividade.Contracts.Services;
using SetimaAtividade.Validators;

namespace SetimaAtividade.Services;
...
public class CadastroService : ICadastroService
{
    ...
    public void AdicionarFuncionario(Funcionario funcionario)
    {
        if (funcionario == null)
        {
            throw new ArgumentException("Há um erro com o funcionario informado.");
        }
